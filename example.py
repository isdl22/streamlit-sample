...
# 원본 데이터프레임 생성
pose = pd.read_csv('D:/data/pose.csv', encoding='ms949')
practice = pd.read_csv('D:/data/practice.csv', encoding='ms949')
dictation = pd.read_csv('D:/data/dictation.csv', encoding='ms949')
