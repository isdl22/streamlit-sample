...
# 원본 데이터프레임 생성
pose = pd.read_csv('data/pose.csv', encoding='ms949')
practice = pd.read_csv('data/practice.csv', encoding='ms949')
dictation = pd.read_csv('data/dictation.csv', encoding='ms949')
